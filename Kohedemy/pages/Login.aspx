<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Kohedemy.Pages.Login" %>
    ...
    <form id="form1" runat="server">
      ...
      <div class="container-with-bg">
        <div class="login-form-container">
          ...
          <asp:Button CssClass="login-button" ID="LoginButton" runat="server" Text="Login" OnClick="LoginButton_Click" />
        </div>
      </div>
